...
function make_html_utils_lib(XLSX) {
  function parse_dom_table(table, _opts) {
    ...
    for (; _R < rows.length && R < sheetRows; ++_R) {
      ...
      for (_C = C = 0; _C < elts.length; ++_C) {
        var elt = elts[_C];
        if (elt.getAttribute("data-exclude") == "true") continue;
  ...
  function save_table_as_excel(table, opts) {
    if (typeof saveAs == "undefined")
      throw new Error(
        "FileSave.js is required. https://github.com/eligrey/FileSaver.js/blob/master/src/FileSaver.js"
      );
...
if (typeof XLSX == "undefined") {
  throw new Error(
    "You need to include xlsx.core.min.js (https://github.com/protobi/js-xlsx/blob/master/dist/xlsx.core.min.js)  before xlsx_html_utils.js"
  );
}
